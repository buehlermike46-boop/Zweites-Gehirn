...
- Hintergrunddienst eingerichtet (`openclaw gateway install` → Scheduled Task „OpenClaw Gateway", startet automatisch mit Windows)
- Dashboard läuft unter http://127.0.0.1:18789/
- Noch offen: Kanäle, Skills (inkl. Obsidian-Skill), Health-Check
...
Noch nicht umgesetzt, nur als Ziel vorgemerkt. Entschieden (10.09.2026): keine Einschränkung nötig, Agent darf bei Installation das komplette Vault sehen (auch 00 Kontext/, Finanzen).
