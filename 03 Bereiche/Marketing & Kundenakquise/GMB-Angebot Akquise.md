...
**Update 25.09.2026, spät abends — zu Gesamtpaket zusammengelegt:** Mike hat entschieden, GMB und Chatbot nicht mehr getrennt anzubieten, sondern als ein Paket für 299 EUR (siehe [[Einnahmequellen-Recherche]], Abschnitt "Idee 1 + 3 zusammengelegt"). Die bereits verschickten 11 Mails dieser Datei (nur GMB) bleiben unverändert stehen, kein Nachfass — bei Antwort wird das Gesamtpaket im Gespräch ergänzt. Jede neue Ansprache läuft ab jetzt über den Gesamtpaket-Text in [[Einnahmequellen-Recherche]], nicht mehr über die reinen GMB-Texte hier.

**Update 25.09.2026, spät abends — neue Ausbaustufe (Website-Komplettpaket):** Zusätzlich zum 299-EUR-Einstiegspaket gibt es jetzt ein höherpreisiges Website-Komplettpaket (eigene Website + Chatbot + GMB-Optimierung, Empfehlung 1.490-2.490 EUR), das die MasterPlan-Stufe-1-Zielspanne tatsächlich trifft. Live-Beispiel unter https://handwerker-chatbot.higgsfield.app (jetzt Mehrseiten-Website statt reiner Chatbot-Demo). Details siehe [[Einnahmequellen-Recherche]], Abschnitt "Idee 2: Website-Komplettpaket". Noch keine Priorisierung, ob/wann dieses Paket neben dem 299-EUR-Einstiegspaket aktiv beworben wird — wartet auf Mikes Entscheidung.
