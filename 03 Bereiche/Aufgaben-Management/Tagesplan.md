...
### Sofort
- [ ] Limitless-Support fragen, ob es eine API oder einen Webhook für den Prospect Tracker gibt — zurückgestellt am 10.09.2026, seitdem nicht weiterverfolgt (Stufe 0: zahlt auf "Lot-Tracking läuft" ein, würde die gerade aufgesetzte manuelle Datenquelle in [[Lot-Tracking]] automatisieren)
...
### Aufwendig
- [ ] Neue Willkommensnachricht im Bot eintragen inklusive Button "Konto eröffnen" — Text bereits fertig in [[Inner Circle Kanal-Content]] Abschnitt 7, nur der Eintrage-Schritt in Make.com fehlt (Stufe 0: Onboarding-Strecke)
